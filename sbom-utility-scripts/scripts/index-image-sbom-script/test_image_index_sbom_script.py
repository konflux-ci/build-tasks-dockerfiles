...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [
                "quay.io/ubi9-micro-container:9.4-6.1716471860@sha256:f08722139c4da653b870272a192fac700960a3315baa1f79f83a4712a436d4"
            ],
            [],
            [],
            {
        ...
        (
            ...
            "sha256:1c8483e0fda0e990175eb9855a5f15e0910d2038dd397d9e2b357630f0321e6d",
            [
                "quay.io/ubi9-micro-container:9.4-6.1716471860@sha256:13fd2a0116a76eaa274fee20c86eef4dfba9f311784e8fb7d7f5fc38b32f3ef"
            ],
            ["amd64"],
            ["ubi-micro"],
            {
...
def test_create_sbom(
    ...
    assert expected_sbom == create_sbom(image_index_url, image_index_digest, child_images, arches, alternative_names)
...
def test_main(
    ...
    mock_args.child_image = ["foo/bar:v1@sha256:123"]
    mock_args.arch = ["arm64"]
